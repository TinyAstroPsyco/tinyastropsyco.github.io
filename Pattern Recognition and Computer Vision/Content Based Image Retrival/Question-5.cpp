...
/*
    ...
    DATE: 02-11-2024
    DESC: This program takes takes a target image and the feature vectors from a external csv file and then reurens the top 3 mathces from the dataset.
*/
...
*/
// Function to calculate sum of squared distance metric between two feature vectors
...
int main() {
    ...
    string q5targetImagePath = "pic.0164.jpg";
...
#include <algorithm> // Include the algorithm header
    ...
    std::sort(q5eucledian_distances.begin(), q5eucledian_distances.end(),
    ...
    for (const auto& q5pair : q5eucledian_distances) {
        std::cout << "Image Path: " << q5pair << endl;
    }
    */
    ...
    unordered_map<string, vector<float>> q5featureVectors = readFeatureVectorsFromCSV(q5path);


    std::cout << "Question 5 feature vectors" << std::endl;
    for (const auto& vector : q5featureVectors) {
        std::cout << "Q 5 Image Path: " << vector.first;
    }
    */
