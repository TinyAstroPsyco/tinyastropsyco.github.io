/*
   ...
   DATE:18,March, 2024
   DESCRIPTION:This code enalbles the insertion of a virtual object into the video feed with a pattern.
*/
...
int main() {
	...
	read_calib_file(K, k);//Reading the camera parameters
	...
	cv::VideoWriter video("C:\\Users\\pooji\\Downloads\\output.mp4", cv::VideoWriter::fourcc('H', '2', '6', '4'), 30, cv::Size(frameWidth, frameHeight));
	if (!video.isOpened()) {
		std::cerr << "Error: Unable to create VideoWriter object" << std::endl;
		return -1;
	}
